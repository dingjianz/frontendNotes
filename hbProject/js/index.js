...
function bannerAutoPlay() {
    ...
    var liS = sliderbanner.getElementsByTagName('li');
    var index = 0;
...
function autoCreatImg() {
    ...
    for (var i = 0; i < 30; i++) {
        ...
        txt = json[i].txt;
        pic = json[i].pic;
        htmlStr = '<div class="box"><div class="pic"><img src=' + pic + '> <div class="cover"></div></div><p>' + txt + '</p><div id="btn_box" class="btn-box"><a href="" class="collect">采集</a><a href="" class="like"><span class="heart"></span> </a> </div></div>';
        str += htmlStr;
